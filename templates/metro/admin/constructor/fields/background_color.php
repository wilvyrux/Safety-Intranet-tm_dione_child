...
<div class="wcp-openweather-settings-field wp-open-weather-field">
    ...
    <div class="wcp-openweather-settings-field-input">
        <input class="<?php echo !empty($class) ? $class : '';?> agp-color-picker" type="hidden" id="<?php echo "{$args->key}[{$args->field}]"; ?>" name="<?php echo "{$args->key}[{$args->field}]"; ?>" value="<?php echo $value;?>">             </div>   
